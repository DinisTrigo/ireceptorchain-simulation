...
import iReceptorPlus.Blockchain.RepastSimulation.MockBlockchainClasses.AtomicVariables.AtomicDouble;
...
public class ChaincodeConfigs
{
    ...
    public static Double baseValueOfTraceabilityDataEntry = 10.0;

    public static Double meanWorkNecessaryForCreatedTraceabilityDataEntries = 20.0;

    public static Double standardDeviationWorkNecessaryForCreatedTraceabilityDataEntries = 20.0;
