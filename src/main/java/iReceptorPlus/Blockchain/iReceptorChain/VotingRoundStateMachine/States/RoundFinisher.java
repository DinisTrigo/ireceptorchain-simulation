...
public class RoundFinisher
{
    ...
    {
        EntireSimulationPerformanceMetrics.registerValidatedEntry(traceabilityData);
        ...
        TraceabilityData newTraceabilityData = new TraceabilityDataValidated(traceabilityData.getInputDatasetHashValue(),
                ...
                traceabilityData.getApprovers(), traceabilityData.getRejecters(), 0.0, traceabilityData.getValid(), traceabilityData.getWorkUnitsNecessary(), traceabilityData.getCreationTime());
    ...
    {
        EntireSimulationPerformanceMetrics.registerInvalidatedEntry(traceabilityData);
        removeTraceabilityDataFromDB();
